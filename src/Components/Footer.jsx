...
const Footer = () => {
  return (
    ...
    <div class="font-medium w-full max-w-screen-full flex flex-row mx-auto p-4  border-t-2 border-zinc-800 justify-evenly">
        ...
        <a href="https://github.com/bhavesh-03" target="_blank" rel="noopener noreferrer" className="flex items-center link text-zinc-200 underline "><FaGithub class="mr-2" />Bhavesh Mankar</a>
    </div>
</footer>
