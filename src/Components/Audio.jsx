...
const AudioPlayer = ({ isMuted, toggleMute }) => {
   ...
   return (
      <div className="lofi-cont fixed bottom-0 left-0 mb-1 ml-4 z-10 flex items-center">
         <div className="music-button text-3xl rounded-3xl bg-gray-600 text-white p-2 mr-3 animate-bounce animate-infinite animate-duration-1000 animate-ease-in-out" onClick={toggleMute}>
            {isMuted ? <MdMusicOff /> : <MdMusicNote />}
         </div>
         {!isMuted && (
            <div className="lofi-artist text-black-500 font-semibold">
