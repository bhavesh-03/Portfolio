...
const GHLink = () => {
  return (
    <a
      ...
      href="http://github.com/bhavesh-03"
      target="_blank"
    ...
    >
      <span aria-hidden="true" className="pointer-events-none absolute inset-0 -z-20">
        ...
        />
        <span aria-hidden="true" className="absolute inset-0 bg-gradient-to-t from-neutral-900/60 to-neutral-900/20 dark:bg-neutral-900/50"></span>
      </span>
