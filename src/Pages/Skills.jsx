        ...
        <Box className="bg-[#000000] min-h-screen">
            ...
            <Box className="px-6 pt-8 mx-auto max-w-screen-lg">
                <div className='heading relative'>
                    <h1 className="text-4xl md:text-5xl font-bold text-white z-10">Skills</h1>
                    <h2 className="text-3xl md:text-4xl font-semibold text-teal-400 absolute top-6 md:top-8">Programming</h2>
                </div>
            </Box>
            ...
            <Box className="flex flex-row flex-wrap my-3 pb-8 bg-white px-6 pt-8 mt-11 gap-24 max-w-screen-lg md:mx-auto mx-7 items-center justify-evenly rounded-3xl">
              <Image src={CppSVG} title="C++" alt="Cpp Logo" width="90" height="90" className="skill-icon hover:scale-125" />
              <Image src={PythonSVG} title="Python" alt="Python Logo" width="90" height="90" className="skill-icon hover:scale-125" />
              <Image src={JavaSVG} title="Java" alt="Java Logo" width="90" height="90" className="skill-icon hover:scale-125" />
              ...
              <Image src={MySQLSVG} title="MySQL" alt="MySql Logo" width="90" height="90" className="skill-icon hover:scale-125" />
